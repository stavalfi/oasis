 ...
 */
import { ProcessWarnings } from "#backend/lib/process-warnings.ts";
...
ProcessWarnings.silenceKafkaTimeoutWarning();
...
class ScraperApp {
  ...
  public constructor() {
    ...
    const producer = new KafkaProducer({
      ...
      topicPartitions: config.constants.kafka.topicPartitions,
    });
